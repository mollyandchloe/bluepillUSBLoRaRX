...
/// You would not expect to get anywhere near these powers to air with a simple 1/4 wavelength wire antenna.
    ...
    /// \return true on success
		...
		bool Radio_printRegisters(void);
    ...
    uint8_t Radio_maxMessageLength(void);
    ...
    /// disables them.
    void           Radio_setModeIdle(void);

    /// If current mode is Tx or Idle, changes it to Rx. 
    /// Starts the receiver in the RF95/96/97/98.
    void           Radio_setModeRx(void);

    /// If current mode is Rx or Idle, changes it to Rx. F
    /// Starts the transmitter in the RF95/96/97/98.
    void           Radio_setModeTx(void);
    ...
    /// power Transmitter power level in dBm. For RFM95/96/97/98 LORA with useRFO false, 
    ...
    /// useRFO If true, enables the use of the RFO transmitter pins instead of
    ...
    bool    Radio_isChannelActive(void);
    ...
    void 	 Radio_setLowDatarate(void);
    ...
    void Radio_validateRxBuf(void);

    /// Clear our local receive buffer
    void Radio_clearRxBuf(void);
