...
bool Radio_init()
{
 ...
 //   	return false;
    ...
    osDelay(10); // Wait for sleep mode to take over from say, CAD
...
*/
    ...
    Radio_setModemConfig(Bw125Cr45Sf128); // Radio default
//    setModemConfig(Bw125Cr48Sf4096); // slow and reliable?
    Radio_setPreambleLength(8); // Default is 8
    // An innocuous ISM frequency, same as RF22's
    Radio_setFrequency(869.4);
    // Lowish power
    Radio_setTxPower(20, true);
...
bool Radio_recv(uint8_t* buf, uint8_t* len)
{
	/*
    if (!available())
	return false;
...
bool Radio_setFrequency(float centre)
{
    // Frf = FRF / FSTEP
...
void Radio_setTxPower(int8_t power, bool useRFO)
{
...
bool Radio_setModemConfig(ModemConfigChoice index)
{
...
// *********please sort pow problem in this function    float symbolTime = 1000.0 * pow(2, SF) / bandwidth;	// ms
...
void Radio_setPayloadCRC(bool on)
{
