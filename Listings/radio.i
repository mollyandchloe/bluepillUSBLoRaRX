...
#line 18 "RHSPIDriver.h"
#line 19 "RHSPIDriver.h"
#line 20 "RHSPIDriver.h"
#line 21 "RHSPIDriver.h"
#line 22 "RHSPIDriver.h"
...
#line 229 "RH_RF95.h"
	...
	Bw125Cr48Sf4096,           
		...
		_Bool Radio_printRegisters(void);

    
    
    
    
    void           Radio_setModemRegisters(const ModemConfig* config);
    ...
    _Bool        Radio_setModemConfig(ModemConfigChoice index);
    ...
    _Bool    Radio_recv(uint8_t* buf, uint8_t* len);
    ...
    _Bool    Radio_send(const uint8_t* data, uint8_t len);
    ...
    void           Radio_setPreambleLength(uint16_t bytes);

    
    
    
    uint8_t Radio_maxMessageLength();
    ...
    _Bool        Radio_setFrequency(float centre);

    
    
    void           Radio_setModeIdle();

    
    
    void           Radio_setModeRx();

    
    
    void           Radio_setModeTx();
    ...
    void           Radio_setTxPower(int8_t power, _Bool useRFO);
    ...
    void     Radio_setSignalBandwidth(long sbw);
    ...
    void     Radio_setCodingRate4(uint8_t denominator);
 	
    
    
    
    
    void 	 Radio_setLowDatarate();
 	
    
    
    
    
    void Radio_setPayloadCRC(_Bool on);
 	

    
    
    
    void           Radio_handleInterrupt();

    
    void Radio_validateRxBuf();

    
    void Radio_clearRxBuf();
...
void Delay (unsigned long tick){
	...
	systickcnt = ((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) )->VAL;
	while((((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) )->VAL - systickcnt ) < tick);
}
...
uint32_t initialiseRadio( void ){
    ...
    GPIO_PortClock   (((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800)), 1);
    GPIO_PinWrite    (((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800)), 3, 1);
    GPIO_PinConfigure(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800)), 3,
                      GPIO_OUT_PUSH_PULL,
                      GPIO_MODE_OUT2MHZ);
    ...
    GPIO_PortClock   (((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800)), 1);
    GPIO_PinConfigure(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800)), 2,
                      GPIO_IN_PULL_UP,
                      GPIO_MODE_INPUT);
    ...
    SPIdrv->Control((0x01UL << 0) | (0UL << 8) | (0UL << 18) | (1UL << 19) | (((8) & 0x3F) << 12), 1000000);
    SPIdrv->Control((0x13UL << 0), 0);

	
	printf("Reseting...\n");
	
		osDelay(100);
		GPIO_PinWrite    (((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800)), 3, 0);	
		GPIO_PinWrite    (((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000)), 13, 0);	
		osDelay(100);
		GPIO_PinWrite    (((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000)), 13, 1); 
		GPIO_PinWrite    (((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800)), 3, 1);	
		osDelay(100);
		
	printf("Reset Complete, configuring radio\n");
    
		RadioSendByte(0x81, 0x80); 
		osDelay(100);
		...
		RadioSendByte(0x01, 0x00); 
		
		osDelay(100);
		
		RadioSendByte(0x8E, 0x00); 
		RadioSendByte(0x8F, 0x00); 
		
		osDelay(100);
		
		RadioSendByte(0x81, 0x01); 
		
		osDelay(100);
		
		RadioSendByte(0x9D, 0x72); 
		RadioSendByte(0x9E, 0x74); 
		RadioSendByte(0xA6, 0x04); 
		
		osDelay(100);
		
		RadioSendByte(0xA0, 0x00); 
		RadioSendByte(0xA1, 0x08); 
		
		osDelay(100);
		
		RadioSendByte(0x86, 0xD9); 
		RadioSendByte(0x87, 0x59); 
		RadioSendByte(0x88, 0x9A); 
		
		osDelay(100);
		
		RadioSendByte(0xCD, 0x04); 
		RadioSendByte(0x89, 0x8f); 
		
		osDelay(100);
		
		printf("Transmit data\n");
		
		RadioSendByte(0x8D, 0x80); 
		...
		RadioSendByte(0xA2, (uint8_t) sizeof(amessage)+3 );  
		
		osDelay(100);
		
		RadioSendByte(0x11, 0x00); 
		uint32_t RegIrqFlagsMask = ((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3000))->DR;
		printf("IFMSK:0x%2X\n", (uint8_t)RegIrqFlagsMask);
		
		RadioSendByte(0x81, 0x03); 
		...
		osDelay(100); 
		uint32_t pinstate = GPIO_PinRead( ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800)), 2); 
		RadioSendByte(0x12, 0x00);	
	

		uint32_t RegIRQFlags = ((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3000))->DR;
		...
		RadioSendByte(0x11, 0x00); 
		RegIrqFlagsMask = ((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3000))->DR;
		printf("IFMSK:0x%2X\n", (uint8_t)RegIrqFlagsMask);
		
		uint32_t oldflag=0x00;
		while(0){		
					RadioSendByte(0x12, 0x00);	
					RegIRQFlags = ((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3000))->DR;
...
void RadioRX( void ){
		...
		uint32_t pinstate = GPIO_PinRead( ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800)), 2); 
		while( pinstate == GPIO_PinRead( ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800)), 2)){} 

		RadioSendByte(0x12, 0x00);	
		RadioSendByte(0x1C, 0x00);	
		
		RadioSendByte(0x13, 0x00);	
		
		RadioSendByte(0x10, 0xFF);	
		
		RadioSendByte(0x8D, 0x00);  
		...
		RadioSendByte(0x92, 0xFF);	
		RadioSendByte(0x19, 0x00);	
		RadioSendByte(0x1A, 0x00);	
		RadioSendByte(0x10, 0xFF);
		RadioSendByte(0x81, 0x01);	
		RadioSendByte(0x92, 0xFF);	
		RadioSendByte(0x92, 0xFF);	
