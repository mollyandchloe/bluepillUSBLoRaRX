...
const osThreadDef_t os_thread_def_Thread_LED = { (Thread_LED), (osPriorityNormal), (1), (0) };        

int Init_Thread_LED (void) {

  tid_Thread_LED = osThreadCreate(&os_thread_def_Thread_LED, 0);
